...
insert into tottenham_squad values(0,14,'이반 페리시치','1989-02-02','공격수',186,77);

#미드필더
insert into tottenham_squad values(0,21,'데얀 클루셰프스키','2000-04-25','미드필더',186,75);
insert into tottenham_squad values(0,19,'라이언 세세뇽','2000-05-18','미드필더',178,70);
insert into tottenham_squad values(0,30,'로드리고밴탄쿠르','1997-06-26','미드필더',187,77);
...
#Q7
update tottenham_squad set p_name = '로드리고 벤탄쿠르' where p_number=30;
#Q8
...
select * from tottenham_squad order by p_number asc; #올림차순
select * from tottenham_squad order by p_number desc; #내림차순
select * from tottenham_squad order by p_height desc, p_weight desc;
#Q12
update tottenham_squad set weekly_pay = 1000 where p_number=9;
update tottenham_squad set weekly_pay = 500 where p_number=22;
